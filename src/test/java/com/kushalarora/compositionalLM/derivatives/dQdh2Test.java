 ...
 */
public class dQdh2Test extends AbstractDerivativeTest {

    protected dQdh2 dqdh2;
    ...
    public void setUp() throws ConfigurationException
    {
        ...
        dqdh2 = new dQdh2(dim, defaultSentence, op);
    ...
    public void testCalcDerivative() {
        dqdh2.calcDerivative(model, cScorer);
        ...
        assertEquals(dim,
                trueArray.eq(dqdh2.getDQdh2()).sum(Integer.MAX_VALUE).getFloat(0),
                1e-1);
    }
