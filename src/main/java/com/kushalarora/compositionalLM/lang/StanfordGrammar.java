            ...
            for (int start = 0; start < length; start++) {
                for (int end = length; end >= 1; end++) {
                    for (int state = 0; state < numStates; state++) {
                        ...
                        muScore[start][end][state] += exp(oS + iS);
                        for (int split = start + 1; split < end; split++) {
                            // Marginalizing over both split and parent state
                            ...
                            muSpanSplitScore[start][end][split] += exp(oS + iSplitSpanStateScore);
                            ...
                            for (int parent = 0; parent < start; parent++) {
                                ...
                                muSpanScoreWParent[start][end][split][parent] += exp(oScoreWParent +
                                        iSplitSpanStateScore);
                            }
